...
export const marineProjects = [
  {
    ...
    name: "KM BUANA",
    type: "Ship",
    description: "Pengecatan ulang kapal nelayan tradisional di Pelabuhan Muara Baru.",
  ...
  },
  {
    ...
    name: "KM JAYA ABADI",
    type: "Cargo Ship",
    description: "Pelapisan anti-karat pada kapal kargo di Pelabuhan Tanjung Priok.",
  ...
  },
  {
    ...
    name: "KM BARUNA",
    type: "Fishing Boat",
    description: "Renovasi dan pengecatan total kapal nelayan di Pelabuhan Muara Angke.",
  ...
  },
  {
    ...
    name: "KM SAMUDRA",
    type: "Ferry",
    description: "Pengecatan dan perbaikan kapal feri penumpang di Pelabuhan Merak.",
...
export const marineArticles = [
  {
    ...
    excerpt: "Pelajari cara merawat cat kapal anda agar tidak mudah terkelupas dan tahan lama meski terkena air laut...",
  ...
  },
  {
    ...
    excerpt: "Panduan lengkap memilih cat yang tepat untuk kapal nelayan tradisional dengan budget terbatas...",
    content: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam in dui mauris. Vivamus hendrerit arcu sed erat molestie vehicula. Sed auctor neque eu tellus rhoncus ut eleifend nibh porttitor. Ut in nulla enim. Phasellus molestie magna non est bibendum non venenatis nisl tempor. Suspendisse dictum feugiat nisl ut dapibus. Mauris iaculis porttitor posuere. Praesent id metus massa, ut blandit odio. Proin quis tortor orci. Etiam at risus et justo dignissim congue. Donec congue lacinia dui, a porttitor lectus condimentum laoreet. Nunc eu ullamcorper orci. Quisque eget odio ac lectus vestibulum faucibus eget in metus. In pellentesque faucibus vestibulum. Nulla at nulla justo, eget luctus tortor.",
  ...
  },
  {
    ...
    excerpt: "Pelajari teknik aplikasi cat anti-fouling yang benar untuk mencegah pertumbuhan organisme laut...",
    content: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam in dui mauris. Vivamus hendrerit arcu sed erat molestie vehicula. Sed auctor neque eu tellus rhoncus ut eleifend nibh porttitor. Ut in nulla enim. Phasellus molestie magna non est bibendum non venenatis nisl tempor. Suspendisse dictum feugiat nisl ut dapibus. Mauris iaculis porttitor posuere. Praesent id metus massa, ut blandit odio. Proin quis tortor orci. Etiam at risus et justo dignissim congue. Donec congue lacinia dui, a porttitor lectus condimentum laoreet. Nunc eu ullamcorper orci. Quisque eget odio ac lectus vestibulum faucibus eget in metus. In pellentesque faucibus vestibulum. Nulla at nulla justo, eget luctus tortor.",
...
export const marineTestimonials = [
  {
    id: "1",
    quote: "Kami sudah menggunakan produk Marine Paint selama 5 tahun terakhir untuk armada kapal kami. Kualitasnya sangat baik dan tahan lama meski sering terkena air laut.",
    author: "Alex Jhoe",
  ...
  {
    id: "2",
    quote: "Layanan konsultasi yang diberikan sangat membantu kami dalam memilih jenis cat yang tepat untuk kapal kami. Tim teknisnya sangat profesional.",
  ...
  {
    id: "3",
    quote: "Produk anti-fouling dari Marine Paint sangat efektif mencegah pertumbuhan teritip dan rumput laut di lambung kapal kami. Sangat direkomendasikan!",
    author: "Carla Wijaya",
