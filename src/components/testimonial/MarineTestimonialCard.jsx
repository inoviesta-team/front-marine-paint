...
export default function MarineTestimonialCard({ 
  ...
  return (
    <div className="max-w-md flex-shrink-0 cursor-pointer group marine-card relative shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden">
      ...
      <div className=" bg-white rounded-lg shadow p-4 border border-gray-200 flex-shrink-0">
