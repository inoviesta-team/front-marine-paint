      ...
      <div className="container mx-auto py-0 px-4 md:px-14">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <h3 className="font-sans font-bold text-white text-2xl my-3">Koko Lie</h3>
          ...
          <div className="flex flex-col md:items-end">
            <div className="mb-0.5 flex items-center">
              <span className="text-xl font-sans font-bold text-white">+628123456789</span>
            </div>
            
            <div className="mb-6 flex items-center">
              <span className="text-lg font-sans font-normal text-white/80">admin@gmail.com</span>
            </div>
            
            <div className="mb-4">
            <div className="flex space-x-4">
              <a href="#" className="flex items-center justify-center text-white hover:bg-marine-blue">
        ...
        <div className="pt-6">
          {/* <div className="flex flex-col items-center mb-4">
            <a href="https://ashdaq.com/" target="_blank" rel="noopener noreferrer" className="text-marine-lightBlue hover:text-white mb-2 flex items-center">
              <span className="mr-1">Official Paint Partner of</span>
              <strong>Ashdaq Paint</strong>
            </a>
          </div> */}
          <p className="font-sans text-md text-white text-center">
